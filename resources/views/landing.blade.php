...
<div>
    ...
    <div class="pt-24">
        <div
            class="container px-20 mx-auto flex flex-wrap flex-col md:flex-row items-center"
        >
            <!--Left Col-->
            <div
                class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left"
            >
                <p class="uppercase tracking-loose w-full">Who we are?</p>
                <h1 class="my-4 text-5xl font-bold leading-tight">
                    Insurance Car Portal
                </h1>
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            ...
            <div class="divide-y divide-rose-400">
                <div class="flex flex-wrap">
                    <div class="w-5/6 sm:w-1/2 p-6 m-auto">
                        ...
                        <p class="text-gray-600 mb-8">
                            Provide us your car plate no., ic, email and answer
                            question provided.
                        </p>
                    </div>
                ...
                <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                    <div class="w-full sm:w-1/2 p-6 mt-6 flex justify-center">
                        <img class="h-48 z-50" src="/images/hero.png" />
                    </div>
                ...
                <div class="flex flex-wrap">
                    <div class="w-5/6 sm:w-1/2 p-6 m-auto">
                        ...
                        <p class="text-gray-600 mb-8">
                            Choose a quotation and pay your car insurance
                            through our portal
                        </p>
                    </div>
                    <div class="w-full sm:w-1/2 p-6 flex justify-center">
                ...
                <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                    ...
                    <div class="w-5/6 sm:w-1/2 p-6 m-auto">
                        ...
                        <p class="text-gray-600 mb-8">
                            We will send you your new insurance.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
        ...
        <h3 class="my-4 text-3xl leading-tight">
            Please don't hesitate, get your quotation today.
        </h3>
        <button
            class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
        >
